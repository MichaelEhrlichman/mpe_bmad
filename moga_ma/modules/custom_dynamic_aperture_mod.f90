...
!----------------------------------------------------------------------
!+
! Subroutine dynamic_aperture_scan(lat, aperture_scan)
!
...
!-
subroutine custom_dynamic_aperture_scan(lat, aperture_scan)
  ...
  do it = 1, aperture_param%n_turn
    ...
    if(do_adts_x .or. do_adts_y) then
      if( it .ge. aperture_param%n_turn-aperture_param%n_adts+1 ) then
        ...
        orbit_temp(ix,0:lat%n_ele_track) = orbit(0:lat%n_ele_track)
      endif
    endif
